...
class RacasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('racas')->insert([
            ...
            'descricao_rac' => 'Reinos ricos de antiga grandeza, salões esculpidos nas raízes das montanhas, o eco de picaretas e martelos nas minas profundas e nas forjas ardentes, um compromisso com o clã e a tradição, e um ódio impetuoso contra goblins e orcs – essas linhas comuns unem todos os anões.',
